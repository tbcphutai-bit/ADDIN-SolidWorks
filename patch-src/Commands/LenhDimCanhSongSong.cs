...
namespace ADDIN.Commands
{
    public class LenhDimCanhSongSong
    {
        ...
        public void Run()
        {
            Debug.WriteLine("[DIM MAT CAT] build=20260716-local-u-envelope-v11");
            ...
            if (selectedArc == null && selectedInputEdge != null)
            {
                EdgeInfo selectedLineGeometry = MakeEdgeInfo(
                    selectedInputEdge,
                    mathUtil,
                    viewTransform);
                EdgeInfo selectedLine = FindMatchingEdgeGeometry(edges, selectedLineGeometry);
        ...
        {
            // referenceArcs da duoc loc theo contour duoc chon, cap cung dong tam
            // hoac cung noi truc tiep hai canh. Khong dung nguong ban kinh co dinh.
            return arc != null && arc.ArcLengthMm > 0.0;
        }
            ...
            out EdgeInfo top)
        {
            ...
            bottom = ExpandHorizontalToLocalExtreme(rawBottom, edges, false);
            top = ExpandHorizontalToLocalExtreme(rawTop, edges, true);
